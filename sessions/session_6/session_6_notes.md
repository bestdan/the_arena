---
tags: [arena, session-notes, session-6]
session_number: 6
party_level: 3
status: planned
visibility: public
...
- Minimize casualties (avoid death curse triggers)
- Defeat or neutralize rival gladiators
- Use environment tactically (thorn bushes, fountain, etc.)
...
- Grapple DC: 16 (Athletics or Acrobatics)

### Special Net
- Location: East archway (Investigation DC 14)
- Effect: Grants advantage on catching attempts
- Found by: [PC name]

### Thorn Bushes
- Dex save DC 12 when entering or starting turn inside
- Damage: 1d6 piercing on failure
- Failure by 5+: Additional 1d4 poison + bleeding (1 damage/round until treated)
- Treatment: DC 10 Medicine check or magical healing
...
- Navigate thorns without damage: +1
...
### Death Curse Triggers (if any)
- 

### Environmental Hazard Casualties
**Thorn Bush Damage:**
- 
...
- Vessa: [Defeated/Surrendered/Survived]
- Tormund: [Defeated/Surrendered/Survived]
- Lira: [Defeated/Surrendered/Survived]
- Finn: [Defeated/Surrendered/Survived]
...
**Mechanical benefit:** Acts as Familiar (Pseudodragon stats), can cast *faerie fire* 1/day

### Ongoing Effects
**Injuries:**
- [PC name]: [Thorn scarring/other]

**Death Curse Survivors:**
- [PC name]: [If survived curse, note special mark/effect]

**Bleeding/Poison:**
- [Any lingering effects]

### Patron Interest
- [Any noble/sponsor reactions]

### Reputation Changes
- [Crowd opinion, Arena Master feedback, etc.]
...
### PC Development
- Who used Animal Handling effectively?
- Any new tactics or teamwork strategies discovered?
- Character moments worth following up on?
- 

### Arena Politics
- Grand Master reaction to the hunt's outcome
- Crowd ratings and future session implications
- Rival team's sponsor response
- 
...
- Consider rematch scenario for future session
- 
...
### Adjustments Made
- [Any on-the-fly balancing, difficulty tweaks, etc.]
