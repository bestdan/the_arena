...
- Mechanics to keep handy: `mechanics/panaches.md`, `mechanics/crowds_favor.md`, `mechanics/last_stand.md`.
...
- Premise: D&D 5e "core rules" gladiatorial saga in Tarsus; Arena blends spectacle with lethal advancement.
...
- Track continuity: injuries, deaths, patron interest, reputation shifts.
